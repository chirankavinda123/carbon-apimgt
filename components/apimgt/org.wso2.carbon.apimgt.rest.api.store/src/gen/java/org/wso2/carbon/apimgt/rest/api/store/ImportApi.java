...
public class ImportApi  {
   ...
   private final ImportApiService delegate = ImportApiServiceFactory.getImportApi();
    ...
    {
        return delegate.importApplicationsPostGetLastUpdatedTime(fileInputStream,fileDetail);
    }
    @PUT
    @Path("/applications")
    @Consumes({ "multipart/form-data" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Import an Update an existing Application.", notes = "This operation can be used to import and update an existing Application.\n", response = ApplicationDTO.class)
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK.\nSuccessful response with the updated object as entity in the body.\n"),
    ...
    public Response importApplicationsPut(@ApiParam(value = "Zip archive consisting of exported application configuration\n") @Multipart(value = "file") InputStream fileInputStream,
    @ApiParam(value = "Zip archive consisting of exported application configuration\n : details") @Multipart(value = "file" ) Attachment fileDetail)
    {
    ...
    {
        return delegate.importApplicationsPutGetLastUpdatedTime(fileInputStream,fileDetail);
    }
}
